...
class Department_of_Critical_Care_Medicine_Menu: Med_Tool_Menu_BaseFragment<MedcaltoolMenuPageFragmentBinding>(), MenuSelectAdapter.OnItemClickListener {
    ...
    override fun initData(): MutableList<String> {
        dataSet = mutableListOf("产后出血量估计与休克指数", "临床常用呼吸机参数设置", "APACHEII评分系统（急性生理和慢性健康评分）", "MODS评分", "呼吸机撤离呼吸参数标准",
