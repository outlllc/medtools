...
class Semen_reference_values : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_semen_reference_values)
        initView()
        initData()
        initData2()
        initData_appendix()
    ...
    private fun initAdaptor() {
        ...
        rv_content2.adapter = MedCalListAdapter(dataSet2, "30")
