...
import com.duckgo.medtools.databinding.ActivityGlomerularFiltrationRateCkdEpiBinding
import com.duckgo.medtools.my_adapter.MedCalListAdapter
import kotlin.math.pow

class Glomerular_Filtration_Rate_CKD_EPI : AppCompatActivity() {
    private lateinit var binding: ActivityGlomerularFiltrationRateCkdEpiBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityGlomerularFiltrationRateCkdEpiBinding.inflate(layoutInflater)
    ...
    private fun initView() {
        ...
        binding.rvContentAppendix.apply {
            layoutManager = LinearLayoutManager(this@Glomerular_Filtration_Rate_CKD_EPI)
