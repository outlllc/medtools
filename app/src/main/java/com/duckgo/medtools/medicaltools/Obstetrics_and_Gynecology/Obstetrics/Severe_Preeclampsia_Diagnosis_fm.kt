...
class Severe_Preeclampsia_Diagnosis_fm : BaseMedListFragment() {
    ...
    private fun provideData() = mutableListOf(
        arrayOf("下列标准至少一条符合者可诊断为重度子痫前期"),
        arrayOf("1.中枢神经系统异常表现：视力模糊、头痛、头晕；严重者神志不清、昏迷等"),
        arrayOf("2.肝包膜下血肿或肝破裂的症状：包括上腹部不适或右上腹持续性疼痛等"),
        arrayOf("3.肝细胞损伤表现：血清转氨酶升高"),
        arrayOf("4.血压改变：收缩压≥160mmHg，或舒张压≥110mmHg"),
        arrayOf("5.血小板减少：＜100×109/L"),
        arrayOf("6.蛋白尿：≥5g/24h，或间隔4小时两次尿蛋白（+++）"),
        arrayOf("7.少尿：24小时尿量＜500ml"),
        arrayOf("8.肺水肿"),
        arrayOf("9.脑血管意外"),
        arrayOf("10.血管内溶血：贫血、黄疸、或乳酸脱氢酶升高"),
        arrayOf("11.凝血功能障碍"),
        arrayOf("12.胎儿生长受限或羊水过少")
    )

    private fun provideAppendix() = mutableListOf(
        arrayOf("结果解读", "高血压加重，尿蛋白增加，或者肾、肝、血液系统的实验室指标异常，或者子痫发作前的症状均表明病情加重。"),
