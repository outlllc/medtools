...
class TestBaseFragment: BaseFragment<FragmentDrugToFetusFmBinding>() {
    override fun getFragmentViewBinding(): FragmentDrugToFetusFmBinding {
        return FragmentDrugToFetusFmBinding.inflate(layoutInflater)
    }


    override fun initAdaptor() {
        binding.rvContent.layoutManager = LinearLayoutManager(activity , LinearLayoutManager.VERTICAL, false)
        binding.rvContent.adapter = MedCalListAdapter(initData(), "31")
        binding.rvContentAppendix.layoutManager = LinearLayoutManager(activity , LinearLayoutManager.VERTICAL, false)
        binding.rvContentAppendix.adapter = MedCalListAdapter(initData_appendix(), "20")
    }

    override fun initData_appendix(): MutableList<Array<String>> {
        var dataSet_appendix: MutableList<Array<String>>  =mutableListOf(arrayOf("相关解释", "药物对胚胎影响大致可分为以下几个时期：" +
    ...
    override fun initData(): MutableList<Array<String>> {
        ...
        var dataSet: MutableList<Array<String>> = mutableListOf()
        dataSet = mutableListOf(subDataSet1, subDataSet2, subDataSet3, subDataSet4, subDataSet5, subDataSet6,
            subDataSet7, subDataSet8, subDataSet9, subDataSet10, subDataSet11, subDataSet12, subDataSet13,
            subDataSet14, subDataSet15, subDataSet16, subDataSet17, subDataSet18, subDataSet19, subDataSet20,
            subDataSet21, subDataSet22, subDataSet23, subDataSet24)
        return dataSet
    }
}